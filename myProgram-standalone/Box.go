...
func (e *Encoder) myType(v *MyType) (err os.Error){
     ...
     if _, _, error := e.t.PointerCheck(unsafe.Pointer(v), "e4bd8f26dccd27e570782c85eb77862b3474c37abec8c85f21621da522bee9a2d6e5f446abca1e5d3e72fe3ef65e53f81649782a0bb30c8044a8e18b71768744", uint64(unsafe.Sizeof(*v))); error == nil {
...
func (e *Encoder) any(a Any) (err os.Error){
     ...
     case MyType:
     	hashByte, err := hex.DecodeString("e4bd8f26dccd27e570782c85eb77862b3474c37abec8c85f21621da522bee9a2d6e5f446abca1e5d3e72fe3ef65e53f81649782a0bb30c8044a8e18b71768744")
	if err != nil {
	   return err
	}
     	// hashByte := []byte("e4bd8f26dccd27e570782c85eb77862b3474c37abec8c85f21621da522bee9a2d6e5f446abca1e5d3e72fe3ef65e53f81649782a0bb30c8044a8e18b71768744")
     	// e.string("e4bd8f26dccd27e570782c85eb77862b3474c37abec8c85f21621da522bee9a2d6e5f446abca1e5d3e72fe3ef65e53f81649782a0bb30c8044a8e18b71768744")
...
func (d *Decoder) any() (retValue *Any, error os.Error) {
     ...
     case bytes.Equal(encodedHash, []byte("e4bd8f26dccd27e570782c85eb77862b3474c37abec8c85f21621da522bee9a2d6e5f446abca1e5d3e72fe3ef65e53f81649782a0bb30c8044a8e18b71768744")):
...
func (t *MyType) CreateDirectory(fd syscall.Fd, name string, label string) (syscall.Status) {
       hash := goodmiddleman.HashValue{ 0xe4,0xbd,0x8f,0x26,0xdc,0xcd,0x27,0xe5,0x70,0x78,0x2c,0x85,0xeb,0x77,0x86,0x2b,0x34,0x74,0xc3,0x7a,0xbe,0xc8,0xc8,0x5f,0x21,0x62,0x1d,0xa5,0x22,0xbe,0xe9,0xa2,0xd6,0xe5,0xf4,0x46,0xab,0xca,0x1e,0x5d,0x3e,0x72,0xfe,0x3e,0xf6,0x5e,0x53,0xf8,0x16,0x49,0x78,0x2a,0x0b,0xb3,0x0c,0x80,0x44,0xa8,0xe1,0x8b,0x71,0x76,0x87,0x44, }  
